"use strict";angular.module("primeiraApp",["ui.router","ngAnimate","toastr","720kb.datepicker","AngularPrint"]);
"use strict";!function(){function a(a,e,o){a.carregando=!1,a.reset=function(){a.truck=angular.copy({})},a.save=function(){a.carregando=!0;var e=a.truck;e.data=window.moment().format("LLL"),e.timestamp=window.moment().toDate().getTime(),firebase.database().ref("caminhao").push(e).then(function(a){var e=moment().format("D"),t=moment().format("M"),n=moment().format("YYYY");firebase.database().ref("data/"+n+"/"+t+"/"+e+"/").push(a.key).then(function(e){o.go("addTruckDone",{key:a.key})})})}}function e(a,e,o,t){a.idade=21,a.visible=!1,a.caminhoes=[],t.info("Fazendo download da lista...","Toda a lista está sendo carregada!"),window.firebase.database().ref("caminhao").orderByChild("timestamp").on("child_added",function(e){var o={};o=e.val(),o.key=e.key,a.caminhoes.push(o),a.$apply()}.bind(this)),a.gotoDetails=function(a){o.go("infoTruck",{key:a})},a.gotoPrint=function(a){o.go("addTruckDone",{key:a})}}function o(a,e,o,t,n){a.carregando=!0,window.firebase.database().ref("caminhao/"+t.key).on("value",function(e){a.info_detailed=e.val(),a.carregando=!1,a.$apply()})}function t(a,e,o,t,n){a.caminhoes=[],a.filter=function(e){a.carregando=!0;var o=e.split("-");console.log(o),window.firebase.database().ref("data/"+o[2]+"/"+o[1]+"/"+o[0]).on("child_added",function(e){console.log(e.val()),window.firebase.database().ref("caminhao/"+e.val()).on("value",function(e){console.log(e.val()),a.caminhoes.push(e.val()),a.carregando=!1,a.$apply()})})}}function n(a,e,o,t,n){a.carregando=!0,a.timeline=[],window.firebase.database().ref("caminhos/"+t.key).on("value",function(e){var o=e.val();for(var t in o)a.timeline.push(o[t]);a.carregando=!1,a.$apply()})}angular.module("primeiraApp").controller("addTruckController",["$scope","$http","$state",a]).controller("listTruck",["$scope","$http","$state","toastr",e]).controller("infolist",["$scope","$http","$state","$stateParams","toastr",o]).controller("infotime",["$scope","$http","$state","$stateParams","toastr",n]).controller("specificListTruck",["$scope","$http","$state","$stateParams","toastr",t])}();
"use strict";!function(){function o(o,a,n){o.carregando=!0,o.apontadores=[],window.firebase.database().ref("users").on("child_added",function(a){var n={};n=a.val(),n.key=a.key,o.apontadores.push(n),o.carregando=!1,o.$apply()}.bind(this))}function a(o,a,n){o.carregando=!1,o.limpar=function(){o.user=angular.copy({})},o.save=function(){swal({title:"Deseja criar um novo usuário?",text:"O usuário será criado com esses dados informados",type:"warning",showCancelButton:!0,confirmButtonColor:"#DD6B55",confirmButtonText:"Sim",closeOnConfirm:!0},function(){o.carregando=!0,o.$apply(),window.firebase.auth().createUserWithEmailAndPassword(o.user.login,o.user.password).then(function(a){window.firebase.database().ref("users/"+a.uid).set({name:o.user.name,contact:o.user.contact}).then(function(a){console.log(a),swal("Criado!","Novo usuário foi criado","success"),o.carregando=!1,o.$apply()})})["catch"](function(o){console.log(o)})})}}angular.module("primeiraApp").controller("cadastroCtrl",["$scope","$http",a]).controller("listApontador",["$scope","$http",o])}();
