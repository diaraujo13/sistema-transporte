...
"use strict";!function(){function a(a,e,t){a.carregando=!1,a.reset=function(){a.truck=angular.copy({})},a.save=function(){a.carregando=!0;var e=a.truck;e.data=window.moment().format("LLL"),e.timestamp=window.moment().toDate().getTime(),firebase.database().ref("caminhao").push(e).then(function(a){var e=moment().format("D"),o=moment().format("M"),n=moment().format("YYYY");firebase.database().ref("data/"+n+"/"+o+"/"+e+"/").push(a.key).then(function(e){t.go("addTruckDone",{key:a.key})},function(a){sweetAlert("Oops...",a,"error")})},function(a){sweetAlert("Oops...",a,"error")})}}function e(a,e,t,o){a.idade=21,a.visible=!1,a.caminhoes=[],o.info("Fazendo download da lista...","Toda a lista está sendo carregada!"),window.firebase.database().ref("caminhao").orderByChild("timestamp").on("child_added",function(e){var t={};t=e.val(),t.key=e.key,a.caminhoes.push(t),a.$apply()}.bind(this)),a.gotoDetails=function(a){t.go("infoTruck",{key:a})},a.gotoPrint=function(a){t.go("addTruckDone",{key:a})}}function t(a,e,t,o,n){a.carregando=!0,window.firebase.database().ref("caminhao/"+o.key).on("value",function(e){a.info_detailed=e.val(),a.carregando=!1,a.$apply()})}function o(a,e,t,o,n){a.caminhoes=[],a.arquivo="Relatorio-",a.xls=function(){$(".table").table2excel({name:"Excel Document Name",filename:a.arquivo+a.date,fileext:".xls"})},a.filter=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:0,t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0;a.carregando=!0,console.log(e,t);var o=e.split("-"),n=new Date(o[2],parseInt(o[1])-1,o[0],0,0,0).getTime(),r=new Date(o[2],parseInt(o[1])-1,o[0],23,59,0).getTime();if(0!=t)var i=t.split("-"),s=(new Date(i[2],parseInt(o[1])-1,i[0],0,0,0).getTime(),new Date(i[2],parseInt(o[1])-1,i[0],23,59,0).getTime());a.caminhoes=[],0==typeof e?sweetAlert("Oops...","Selecione uma data!","error"):window.firebase.database().ref("data/").on("child_added",function(e){console.log(n,e.val().timestamp,s),window.firebase.database().ref("caminhao/"+e.val().chave).on("value",function(o){var i=e.val();i.dataformatada=window.moment(e.val().timestamp).format("D/MM/Y H:m"),i.empresa=o.val().empresa,i.cargaInicial=o.val().carga,i.numero=o.val().numero,i.obs=o.val().obs,i.placa=o.val().placa,i.contato=o.val().contato,0==t?e.val().timestamp>=n&&e.val().timestamp<=r&&a.caminhoes.push(i):e.val().timestamp>=n&&e.val().timestamp<=s&&a.caminhoes.push(i),a.carregando=!1,a.$apply()})})}}function n(a,e,t,o,n){a.carregando=!0,window.firebase.database().ref("caminhos/"+o.key).on("value",function(e){a.timeline=[],a.$apply();var t=e.val();for(var o in t)a.timeline.push(t[o]);a.carregando=!1,a.$apply()})}angular.module("primeiraApp").controller("addTruckController",["$scope","$http","$state",a]).controller("listTruck",["$scope","$http","$state","toastr",e]).controller("infolist",["$scope","$http","$state","$stateParams","toastr",t]).controller("infotime",["$scope","$http","$state","$stateParams","toastr",n]).controller("specificListTruck",["$scope","$http","$state","$stateParams","toastr",o])}();
